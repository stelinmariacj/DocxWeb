	...
	<div class="recipient_reg" style="background-color:#272327;">
		...
		<form enctype="multipart/form-data" action=""  method="post" class="text-center" style="margin-left: 110px">
			 <div class="col-md-12">
					...
					<label>Name:
					    <input type="text" name="name" value="" placeholder="Full name" autocomplete="off" required>
					</label><br><br>
					<label>Address:
						 <input type="text" name="address" value="" placeholder="address" pattern="[a-zA-Z]{1-100}" required >
					</label><br><br>
					<label>Contact no:
						 <input type="text" name="contact" value="" placeholder="contact required" maxlength="10" pattern="[0-9]{10}"  >
					</label><br><br>
					...
					<label>Fee:
					   <input type="text" name="fee" value="" placeholder="Fee"  pattern="{1-10000}"required >
					</label><br><br>
					<label>User ID:
					     <input type="text" name="userid" value="" placeholder="userid" pattern="[a-zA-Z]{1-100}" required>
					</label><br><br>
					
					<label>Password:
					   <input type="password" name="password" value="" placeholder="password" required="true" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" title="Must contain at least one  number and one uppercase and lowercase letter, and at least 6 or more characters"> 
					</label><br><br>
					<label>
						 <input type="file" name="pic" value="" id="pic" required>
					</label><br><br>
					
					<button name="submit" type="submit" style="margin-left:148px;margin-top: 4px;width:95px;border-radius: 3px;height: 30px" required>Add Doctor</button> <br>
