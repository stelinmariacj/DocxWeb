	...
	<div class="contactus"  style="background-color:#fff;">
		...
		<div class="main_content">
			<div class="col-md-6" style="border-right: 2px solid black;">
				<article>
					<h2>Ms.Stelin Maria C J <h2><h2>Ms.Linu Charly</h2><h2>Ms.Amrutha Ajay</h2><h4>Studied Master of Computer Applications</h4>
							<h5>Vidya Academy Of science and Technology,Thrissur</h5>
